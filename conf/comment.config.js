...
module.exports = {
  ...
  COMMENT_WALINE_SERVER_URL: process.env.NEXT_PUBLIC_WALINE_SERVER_URL || 'https://my-waline-repo-gawainxs-projects.vercel.app', // 请配置完整的Waline评论地址 @see https://waline.js.org/guide/get-started.html
